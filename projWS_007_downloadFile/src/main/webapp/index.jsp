...
<body>
	...
	<a href="http://localhost:8085/projWS_007_downloadFile/">WEB API (index)</a><br/><br/>
	
	<h3>/projWS_001_template/americolib/ws/file/get/</h3>
	<a href="http://localhost:8085/projWS_007_downloadFile/americolib/ws/file/get">Download Text File</a><br/><br/>	
