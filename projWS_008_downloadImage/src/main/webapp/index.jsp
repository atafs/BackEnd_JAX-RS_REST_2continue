...
<body>
	...
	<a href="http://localhost:8085/projWS_008_downloadImage/">WEB API (index)</a><br/><br/>
	
	<h3>/projWS_001_template/americolib/ws/image/get/</h3>
	<a href="http://localhost:8085/projWS_008_downloadImage/americolib/ws/image/get">Download Image File</a><br/><br/>	
